...
# Generate from model
target = generate_scatterers_from_model('Cybertruck.obj', num_centers=200, rcs_scale=20.0, edge_bias=1.0, edge_rcs_boost=1.5, aspect_angle_deg=90.0)  # dB edges
...
plot_space_2d(image, radar, window=5)